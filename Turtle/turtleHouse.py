#
# Sample Turtle program that draws a house - needs corrections
#
#
...
# functions that draw different components
...
# Create a new turtle instance and give it a name.
pen = turtle.Turtle()
...
# Start drawing by calling drawing functions and passing in input parameters
